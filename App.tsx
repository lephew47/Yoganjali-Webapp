  ...
  return (
    <div className="bg-white py-20">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="prose prose-lg prose-stone mx-auto">
          <p>
            Welcome to Yoganjali Global Institute of Applied Yogic Sciences (YGIAYS) –
            a sanctuary where Yoga is honored not just as exercise, but as a complete
            science for the body, mind, and soul.
          </p>

          <p>
            Founded in Bengaluru by <strong>Gopinath Acharya</strong>, Yoganjali
            embodies the perfect blend of classical wisdom and modern understanding.
            Gopinath Acharya devoted six years to earn his Postgraduate Diploma in
            Yoga Therapy at Prashanthi Kuteeram, SVYASA, and further deepened his
            practice through immersive experiences in the Himalayas and renowned yoga
            centers across India in the 1990s.
          </p>

          <p>
            He shared his knowledge globally, leading workshops and seminars across
            Asia, Africa, Australia, America and Europe. Observing the widespread
            effects of stress, he developed a holistic yoga toolkit designed to
            restore balance, cultivate health, and nurture inner peace.
          </p>

          <p>
            With this vision, Yoganjali was founded in 2002. Since then, we have
            conducted a wide range of yoga programs, tailored to meet the evolving
            needs of humanity. This unique synthesis of classical wisdom and modern
            scientific understanding forms the foundation of a time-tested,
            practical, and transformative science of Yoga.
          </p>
                ...
                <div className="flex flex-col lg:flex-row min-h-screen max-w-7xl mx-auto pt-8 px-4 gap-8">
                   <div className="w-full">
                     ...
                     <div className="mt-8 p-6 bg-amber-50 rounded-xl border border-amber-100 flex justify-between items-center">
                        ...
                        <Link to="/ai-therapy" className="bg-amber-600 text-white px-6 py-2 rounded-full font-bold hover:bg-amber-700 transition">
                            Open Chat
                        </Link>
                     </div>
                   </div>
